				...
				$ : function( realElement )
				{
						if ( realElement.name == 'video' )
						{
							...
							var width = realElement.attributes.width,
								...
								// preload = realElement.attributes.preload;
...
var de = {
		toolbar	: 'Video',
		dialogTitle : 'Video Eigenschaften',
		fakeObject : 'Video',
		properties : 'Video editieren',
		widthRequired : 'Das Feld „Breite“ darf nicht leer sein',
		heightRequired : 'Das Feld „Höhe“ darf nicht leer sein',
		poster: 'Vorschaubild',
		preload: 'Preload',
		sourceVideo: 'Video Datei',
		sourceType : 'Video Typ',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Ihr Browser unterstützt die Videowiedergabe nicht.<br>Videodatei Download: %links%'
	};
...
CKEDITOR.plugins.setLang( 'video', 'de', de );

 ...
 * Copyright (C) 2011 JUergen Krausz, code based almost completely on 
 * Video Plugin by Alfonso Martínez de Lizarrondo
 *
 * == BEGIN LICENSE ==
 *
...
var en = {
		...
		fallbackTemplate : 'Your browser doesn’t support html5 audio.<br>Please download the file: %links%'
	};

var de = {
		toolbar	: 'Audio',
		dialogTitle : 'Audio Eigenschaften',
		fakeObject : 'Audio',
		properties : 'Audio bearbeiten',
		preload: 'Preload',
		sourceAudio: 'Audio Datei',
		sourceType : 'Audio Typ',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Ihr Browser unterstützt die html5 Audiowiedergabe nicht.<br>Audiodatei Download: %links%'
	};
...
var es = {
		...
		sourceType : 'Tipo',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Su navegador no soporta html5 audio.<br>Por favor, descargue el fichero: %links%'
	};
...
CKEDITOR.plugins.setLang( 'audio', 'de', de );

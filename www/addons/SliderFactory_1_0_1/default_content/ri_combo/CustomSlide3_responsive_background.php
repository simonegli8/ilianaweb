...
$newSection = array (
  ...
  . $addonRelativeCode . '/default_content/images/SliderFactory-SampleBg-03.png"></div><div class="responsive_image_caption_wrapper caption-show-never" style="background-color:rgba(0,0,0,0.75);"><div class="responsive_image_caption"></div></div></a>',
